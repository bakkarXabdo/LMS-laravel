...
@section('PageTitle') إدخال ملف إكسل @endsection
...
<div class="container" dir="rtl"  style="margin-top: 3rem">
    ...
    <form id="form"
        ...
        <div class="">
            ...
            <label style="font-size: 1.5rem;font-weight: bold" for="unique">إحذِف النُسخ المُكررة في الملف</label>
        </div>
        <hr/>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 0"><input class="form-control" style="width: 100%;max-width: none;height: 100%;max-height: none;" name="pos[InventoryId]" value="2"></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">الشفرة</td>
                        <td style="padding: 0"><input class="form-control" style="width: 100%;max-width: none;height: 100%;max-height: none;" name="pos[Code]" value="3"></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">العنوان</td>
                        <td style="padding: 0"><input class="form-control" style="width: 100%;max-width: none;height: 100%;max-height: none;" name="pos[Title]" value="4"></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">المؤلف</td>
                        <td style="padding: 0"><input class="form-control" style="width: 100%;max-width: none;height: 100%;max-height: none;" name="pos[Author]" value="5"></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">الناشر</td>
                        <td style="padding: 0"><input class="form-control" style="width: 100%;max-width: none;height: 100%;max-height: none;" name="pos[Publisher]" value="6"></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">سنة النشر</td>
                        <td style="padding: 0"><input class="form-control" style="width: 100%;max-width: none;height: 100%;max-height: none;" name="pos[ReleaseYear]" value="7"></td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">السعر</td>
                        <td style="padding: 0"><input class="form-control" style="width: 100%;max-width: none;height: 100%;max-height: none;" name="pos[Price]" value="8"></td>
                    </tr>
                </tbody>
            </table>
        </div>
