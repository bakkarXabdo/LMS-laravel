...
<div style="height: 400px">
  <form action="{{url('/search')}}" method="get" class="form-container">
    ...
    />
    <i class="glyphicon glyphicon-searchno "></i>
    
    <h5>or filter</h5>
    <div class="drop-container">
      <ul>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" href="#">Category</a>
